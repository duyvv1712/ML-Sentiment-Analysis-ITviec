...
**Nguyễn Duy Khang trình bày:** Em xin tiếp tục với phần live demo. Trong phần này, em sẽ minh họa ba bước: nhập một review mới, quan sát nhãn cùng xác suất dự đoán, sau đó kiểm tra văn bản đã xử lý và các token TF-IDF nổi bật.

Sau slide dẫn dắt này, em xin chuyển sang ứng dụng Streamlit để thao tác trực tiếp. Em sẽ dùng một câu tiếng Việt mới để kiểm tra đúng pipeline mà nhóm đã trình bày.

**Khi đã chuyển sang ứng dụng:** Đầu tiên, em nhập review và bấm dự đoán. Tiếp theo, em đọc nhãn cùng xác suất của ba lớp. Cuối cùng, em mở phần văn bản sau tiền xử lý và các token nổi bật để kiểm tra dữ liệu đầu vào của mô hình.
